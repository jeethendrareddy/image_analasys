...
MODELS_DIR = r"D:\PyCharm Community Edition 2024.3.5\PROJECTS\Arhar_Khesari_Dal\Models\Test-12"
...
X = np.load(os.path.join(FEATURES_DIR, "DenseNet_features_10.npy"))
y = np.load(os.path.join(FEATURES_DIR, "DenseNet_labels_10.npy"))
...
# ---------------- SVM ----------------
print("\n🔹 Training SVM...")
svm = SVR(C=50, kernel="rbf", gamma="scale")  # tuned params
...
rf = RandomForestRegressor(n_estimators=300,max_depth=40, random_state=42)
