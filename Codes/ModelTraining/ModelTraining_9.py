...
from config import FEATURES_DENSENET_8, MODELS_TEST_9_DIR, RESULTS_DIR, RANDOM_STATE

os.makedirs(MODELS_TEST_9_DIR, exist_ok=True)
...
joblib.dump(svm, os.path.join(MODELS_TEST_9_DIR, "SVM_DenseNet.pkl"))
...
joblib.dump(rf, os.path.join(MODELS_TEST_9_DIR, "RandomForest_DenseNet.pkl"))
...
joblib.dump(dt, os.path.join(MODELS_TEST_9_DIR, "DecisionTree_DenseNet.pkl"))
