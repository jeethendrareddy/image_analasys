...
from config import MODELS_TEST_8_DIR

# Load trained models
svm_model = joblib.load(os.path.join(MODELS_TEST_8_DIR, "SVM_model.pkl"))
rf_model = joblib.load(os.path.join(MODELS_TEST_8_DIR, "RandomForest_model.pkl"))
dt_model = joblib.load(os.path.join(MODELS_TEST_8_DIR, "DecisionTree_model.pkl"))
