...
from config import MODELS_TEST_9_DIR
...
# Load trained models
svm_model = joblib.load(os.path.join(MODELS_TEST_9_DIR, "SVM_DenseNet.pkl"))
rf_model = joblib.load(os.path.join(MODELS_TEST_9_DIR, "RandomForest_DenseNet.pkl"))
dt_model = joblib.load(os.path.join(MODELS_TEST_9_DIR, "DecisionTree_DenseNet.pkl"))
